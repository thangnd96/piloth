...
cd "$1"
cp CLAUDE.md goc.md
printf '{"plan_version":1,"mode":"greenfield","adapters":["claude"],"steps":[{"op":"fill_placeholders","target":"CLAUDE.md"},{"op":"append_lines","target":".claude","lines":["x"]},{"op":"write_marker"}]}' > plan.json
